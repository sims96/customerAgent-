...
(function() {
  ...
  window.ui = {
    ...
    disconnect() {
      ...
      // NEW: Call dashboard disconnect handler
      if (typeof window.handleDashboardDisconnect === 'function') {
        window.handleDashboardDisconnect();
      }
    ...
    updateConnectionStatus(connected, message = '') {
      ...
      if (connected) {
        ...
        // Show notification bell when connected
        if (this.elements.notificationBell) {
